                                ...
                                <div class="col-lg-12 col-xl-8 col-12">
                                    ...
                                    <div class="ed-blog__details-main">
                                        <div class="ed-blog__details-top">
                                            ...
                                            <div class="ed-blog__details-cover">
                                                <div class="ed-blog__details-cover-img">
                                                    <img src="assets/images/blog/blog-details/b-details-img-1.png"
                                                        alt="b-details-img-1" />
                                                </div>
                                                <ul class="ed-blog__details-meta">
                                                    <li><i class="fi fi-rr-calendar"></i>30 April, 2024</li>
                                                    <li><i class="fi fi-rr-comment-alt-dots"></i>18 Comments</li>
                                                    <li>
                                            ...
                                            <p class="ed-blog__details-text">
                                                ...
                                                voluptate velit esse cillum dolore eu fugiat nulla pariatur enim ipsam.
                                            </p>
                                            <br />
                                            <p class="ed-blog__details-text">
                                                Lorem ipsum dolor sit amet consectur adipisicing elit, sed do eiusmod
                                        ...
                                        <div class="ed-blog__details-widget">
                                            <h5 class="ed-blog__details-widget-title">
                                        ...
                                        <div class="ed-blog__details-widget-img">
                                            <img src="assets/images/blog/blog-details/b-details-img-2.png"
                                                alt="b-details-img-2" />
                                            <img src="assets/images/blog/blog-details/b-details-img-3.png"
                                                alt="b-details-img-3" />
                                        </div>
                                        ...
                                        <div class="ed-blog__details-comment">
                                            <h3 class="ed-blog__comment-title">2 Comment</h3>
                                            <!-- Single Comment -->
                                            <div class="ed-blog__comment-item">
                                                <div class="ed-blog__comment-img">
                                                    <img src="assets/images/blog/blog-details/comment-1.png"
                                                        alt="comment-1" />
                                                </div>
                                                <div class="ed-blog__comment-info">
                                                    <div class="ed-blog__comment-info-head">
                                                        <h6 class="ed-blog__comment-name">John Smith</h6>
                                                        <a href="#" class="ed-blog__comment-reply">Reply</a>
                                                    </div>
                                                    <p class="ed-blog__comment-text">
                                                        Fusce condimentum enim vestibulum libero gravida, ut accumsan
                                                        quam bibendum. Curabitur gravida est sit amet cursus.
                                                    </p>
                                                </div>
                                            </div>
                                            <!-- Single Comment -->
                                            <div class="ed-blog__comment-item reply-comment">
                                                <div class="ed-blog__comment-img">
                                                    <img src="assets/images/blog/blog-details/comment-2.png"
                                                        alt="comment-2" />
                                                </div>
                                                <div class="ed-blog__comment-info">
                                                    <div class="ed-blog__comment-info-head">
                                                        <h6 class="ed-blog__comment-name">Franklin Chen</h6>
                                                        <a href="#" class="ed-blog__comment-reply">Reply</a>
                                                    </div>
                                                    <p class="ed-blog__comment-text">
                                                        Fusce condimentum enim vestibulum libero gravida, ut accumsan
                                        ...
                                        <!-- Blog Details Form -->
                                        <div class="ed-blog__details-form">
                                            <h3 class="ed-blog__details-form-title">Leave a Reply</h3>
                                            <form action="#" method="post">
                                                ...
                                                <div class="ed-blog__details-form-btn">
                                                    <button type="submit" class="ed-btn">Post a Comment<i
                                ...
                                <div class="col-lg-6 col-xl-4 col-md-8 col-12">
                                    <div class="ed-blog__sidebar">
                                        ...
                                        <div class="ed-blog__sidebar-widget">
                                            <h4 class="ed-blog__sidebar-title">Search Here</h4>
                                            <form action="#" method="post" class="ed-blog__sidebar-search">
                                        ...
                                        <!-- Single Sidebar Widget -->
                                        <div class="ed-blog__sidebar-widget">
                                            <h4 class="ed-blog__sidebar-title">Categories</h4>
                                        ...
                                        <!-- Single Sidebar Widget -->
                                        <div class="ed-blog__sidebar-widget">
                                            <h4 class="ed-blog__sidebar-title">Popular News</h4>
                                            <div class="ed-blog__latest">
                                                <!-- Single Latest -->
                                                <div class="ed-blog__latest-item">
                                                    <div class="ed-blog__latest-img">
                                                        <img src="assets/images/blog/blog-details/latest-1.png"
                                                            alt="latest-1" />
                                                    </div>
                                                    <div class="ed-blog__latest-info">
                                                        <a href="blog-details.html">How to Start a Blog Beginner Best
                                                            Tooling</a>
                                                ...
                                                <div class="ed-blog__latest-item">
                                                    <div class="ed-blog__latest-img">
                                                        <img src="assets/images/blog/blog-details/latest-2.png"
                                                            alt="latest-2" />
                                                    </div>
                                                    <div class="ed-blog__latest-info">
                                                        <a href="blog-details.html">Start Your Career for Your Best
                                                            Planning Days</a>
                                                ...
                                                <div class="ed-blog__latest-item">
                                                    <div class="ed-blog__latest-img">
                                                        <img src="assets/images/blog/blog-details/latest-3.png"
                                                            alt="latest-3" />
                                                    </div>
                                                    <div class="ed-blog__latest-info">
                                                        <a href="blog-details.html">How to Start a Blog Beginner Best
                                        ...
                                        <!-- Single Sidebar Widget -->
                                        <div class="ed-blog__sidebar-widget">
                                            <h4 class="ed-blog__sidebar-title">Contact Us</h4>
                                            <!-- Sigle Info  -->
                                        ...
                                        <!-- Single Sidebar Widget -->
                                        <div class="ed-blog__sidebar-widget">
                                            <h4 class="ed-blog__sidebar-title">Popular Tags</h4>

                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="ed-breadcrumbs__content">
                                        <h3 class="ed-breadcrumbs__title">Lucent Advance Maths – Full Solution</h3>
                                        <ul class="ed-breadcrumbs__menu">
                                            <li class="active"><a href="index.php">Home</a></li>
                                            <li>/</li>
                                            <li>Lucent Advance Maths – Full Solution</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-xl-12 col-12">
                                    <div class="row align-items-center g-0">
                                        <div class="col-lg-5 col-12">
                                            ...
                                            <div class="ed-shop-thumb">
                                                <img src="https://i0.wp.com/uttamcareer.in/wp-content/uploads/2024/03/2-min-1651478806562.png?w=500&ssl=1"
                                        ...
                                        <div class="col-lg-7 col-12">
                                            ...
                                            <div class="product__details-inner">
                                                ...
                                                <div class="ed-product-short">
                                                    <h3>Lucent Advance Maths – Full Solution</h3>
                                                    <p>UCI DIGITAL is one of India’s premier training institutes, widely
                                                        recognized for providing top-notch education and training for
                                                        Defence exams. We specialize in both classroom teaching and
                                                        outdoor training, and our comprehensive approach to exam
                                                        preparation ensures that each student is well-equipped to
                                                        achieve success.
                                                    </p>
                                                    <p class="mt-3"> Our institute takes immense pride in delivering
                                                        personalized and highly effective training for competitive
                                                        exams. With a team of Ex-Defence Officers, Examiners, and
                                                        qualified teachers, we guarantee high-quality instruction that
                                                        is backed by years of experience in Defence education. </p>
                                                    <br>
                                                    ...
                                                    <ul class="ed-blog__details-list">
                                                        <li>
                                                            <img src="assets/images/icons/icon-check-blue.svg"
                                                                alt="icon-check-blue" />
                                                            <strong> Ideal for Quick Revision</strong>
                                                        ...
                                                        <li>
                                                            ...
                                                            <strong>
                                                                Targeted for All Competitive Exams
                                                            </strong>
                                                ...
                                                <div class="col-lg-4">
                                                    <ul class="ed-blog__details-list">
                                                        <li>
                                                            <img src="assets/images/icons/icon-check-blue.svg"
                                                                alt="icon-check-blue" />
                                                            <strong> In-depth Coverage of Advanced Mathematics</strong>
                                                        </li>
                                                        <li>
                                                            <img src="assets/images/icons/icon-check-blue.svg"
                                                                alt="icon-check-blue" />
                                                            <strong> Best for Time Management </strong>
                                                        </li>
                                                ...
                                                <div class="col-lg-4">
                                                    <ul class="ed-blog__details-list">
                                                        <li>
                                                            <img src="assets/images/icons/icon-check-blue.svg"
                                                                alt="icon-check-blue" />
                                                            <strong>Perfect for Exam Day Preparation</strong>
                                                        </li>
                                                        <li>
                                                            <img src="assets/images/icons/icon-check-blue.svg"
                                                                alt="icon-check-blue" />
                                                            <strong>Continuous Improvement and Progress
                                                                Tracking.</strong>
                                                        </li>
                                                    </ul>
                                    ...
                                    <p class="ed-blog__details-text mt-5">
                                        ...
                                        Bank P.O. etc.In this particular course we will cover Advance Maths with
                                        concepts and a lot of practice questions.Best Book To Practice a Huge Bunch of
                                        Questions before your examination.
                                    </p>

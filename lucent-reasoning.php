                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="ed-breadcrumbs__content">
                                        <h3 class="ed-breadcrumbs__title">Lucent Reasoning- Full Solution</h3>
                                        <ul class="ed-breadcrumbs__menu">
                                            <li class="active"><a href="index.php">Home</a></li>
                                            <li>/</li>
                                            <li>Lucent Reasoning- Full Solution</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-xl-12 col-12">
                                    <div class="row align-items-center g-0">
                                        <div class="col-lg-5 col-12">
                                            ...
                                            <div class="ed-shop-thumb">
                                                <img src="https://i0.wp.com/uttamcareer.in/wp-content/uploads/2024/03/1-min-1651479186630.png?w=500&ssl=1"
                                        ...
                                        <div class="col-lg-7 col-12">
                                            ...
                                            <div class="product__details-inner">
                                                ...
                                                <div class="ed-product-short">
                                                    <h3>Lucent Reasoning- Full Solution</h3>
                                                    <p>UCI DIGITAL is one of India’s most reputed training institutes,
                                                        specializing in providing top-tier preparation for Defence
                                                        exams. Whether it’s classroom teaching or outdoor training, we
                                                        ensure that you receive the finest education with an edge over
                                                        the competition. Our experienced team, which includes Ex-Defence
                                                        Officers, Examiners, and qualified teachers, is dedicated to
                                                        offering unmatched guidance and expertise.
                                                    </p>
                                                    <p class="mt-3"> We take pride in our HYBRID LEARNING MODEL,
                                                        offering both online and offline classes to suit your learning
                                                        preferences. Join UCI DIGITAL, and set
                                                        yourself on the path to achieving your Defence exam goals. With
                                                        us, you’ll receive the right guidance, support, and motivation
                                                        to become the best and excel in your exams.</p>
                                                    <br>
                                    ...
                                    <div class="ed-blog__details-main">
                                        <div class="ed-blog__details-top">
                                            ...
                                            <h2 class="ed-blog__details-title mt-3">
                                                Key Features of Online Paid Courses:
                                            </h2>
                                                ...
                                                <div class="col-lg-4">
                                                    <ul class="ed-blog__details-list">
                                                        <li>
                                                            <img src="assets/images/icons/icon-check-blue.svg"
                                                                alt="icon-check-blue" />
                                                            <strong>Regular Practice with a Huge Question Bank.</strong>
                                                        </li>
                                                        <li>
                                                            <img src="assets/images/icons/icon-check-blue.svg"
                                                                alt="icon-check-blue" />
                                                            <strong>Comprehensive Guidance for Defence
                                                                Aspirants.</strong>
                                                        </li>
                                                        <li>
                                                            <img src="assets/images/icons/icon-check-blue.svg"
                                                                alt="icon-check-blue" />
                                                            <strong>Consistency and Regularity.</strong>
                                                        </li>
                                                    </ul>
                                                ...
                                                <div class="col-lg-4">
                                                    <ul class="ed-blog__details-list">
                                                        <li>
                                                            <img src="assets/images/icons/icon-check-blue.svg"
                                                                alt="icon-check-blue" />
                                                            <strong> Focused on Reasoning.</strong>
                                                        </li>
                                                        <li>
                                                            <img src="assets/images/icons/icon-check-blue.svg"
                                                                alt="icon-check-blue" />
                                    ...
                                    <p class="ed-blog__details-text mt-5">
                                        ...
                                        Bank P.O. etc. In this particular course we will cover REASONING with concept
                                        and a lot of practice questions. Best Book To Practice a Huge Bunch of Questions

...
<head>
    ...
    <style>
        ...
        .ed-btn {
            ...
            background-image: linear-gradient(to right, #F5961B 0%, #eb0000 51%, #F5961B 100%) !important;
            color: var(--ed-white-color);
            font-size: 16px;
            font-weight: 500;
            line-height: 20px;
        ...
        <div id="smooth-content">
            <main>
                <div class="section-bg hero-bg">
                                ...
                                <div class="col-lg-6 col-xl-4 col-md-8 col-12">
                                    <div class="ed-blog__sidebar">
                                        ...
                                        <div class="ed-blog__sidebar-widget">
                                            <h4 class="ed-blog__sidebar-title">Enquiry Now</h4>
                                            <form action="#" method="post" class="ed-blog__sidebar-search">
                                                ...
                                                <input type="text" name="city" placeholder="City *" required=""
                                                    class="mt-3" />
                                                <select class="form-select form-control mt-3 mb-4"
                                                ...
                                                <div class="col-12">
                                                    <div class="ed-contact__form-btn mt-4">
                                                        <button type="submit" class="ed-btn">Submit</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
                    ...
                    <!-- Start Course Area -->
                    <section class="ed-course section-gap position-relative background-image"

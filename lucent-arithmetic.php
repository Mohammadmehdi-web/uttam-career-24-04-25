                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="ed-breadcrumbs__content">
                                        <h3 class="ed-breadcrumbs__title">Lucent Arithmetic- Full Solution</h3>
                                        <ul class="ed-breadcrumbs__menu">
                                            <li class="active"><a href="index.php">Home</a></li>
                                            <li>/</li>
                                            <li>Lucent Arithmetic- Full Solution</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-xl-12 col-12">
                                    <div class="row align-items-center g-0">
                                        <div class="col-lg-5 col-12">
                                            ...
                                            <div class="ed-shop-thumb">
                                                <img src="https://i0.wp.com/uttamcareer.in/wp-content/uploads/2024/03/4-min-1651479416425.png?w=500&ssl=1"
                                        ...
                                        <div class="col-lg-7 col-12">
                                            ...
                                            <div class="product__details-inner">
                                                ...
                                                <div class="ed-product-short">
                                                    <h3>Lucent Arithmetic- Full Solution</h3>
                                                ...
                                                <div class="col-lg-4">
                                                    <ul class="ed-blog__details-list">
                                                        <li>
                                                            <img src="assets/images/icons/icon-check-blue.svg"
                                                                alt="icon-check-blue" />
                                                            <strong> Focused Entire Elementary Mathematics</strong>
                                                        </li>
                                                        <li>
                                                            <img src="assets/images/icons/icon-check-blue.svg"
                                                                alt="icon-check-blue" />
                                    ...
                                    <p class="ed-blog__details-text mt-5">
                                        ...
                                        Bank P.O. etc.
                                        In this particular course we will cover entire Elementary Mathematics with
                                        concept and a lot of practice questions.

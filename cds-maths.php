                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="ed-breadcrumbs__content">
                                        <h3 class="ed-breadcrumbs__title">CDS MATHS</h3>
                                    ...
                                    <div class="row align-items-center g-0">
                                        <div class="col-lg-5 col-12">
                                            ...
                                            <div class="ed-shop-thumb">
                                                <img src="https://i0.wp.com/uttamcareer.in/wp-content/uploads/2024/03/400RecordedLecturesTestSeriesStudyMaterial1YearProgramme1-1652686761911.png?resize=1080%2C331&ssl=1"
                                        ...
                                        <div class="col-lg-7 col-12">
                                            ...
                                            <div class="product__details-inner">
                                                ...
                                                <div class="ed-product-short">
                                                    <h3>Start Your Journey to Success in CDS with Our Mathematics
                                                        Course!</h3>
                                                    <p>
                                                        Get ready to succeed in the CDS (Combined Defence Services) exam
                                                        with our special Mathematics course. This course is made to take
                                                        you from the basics to advanced topics in a simple and clear
                                                        way.Our 6-month program is carefully planned to help you build
                                                        strong knowledge step-by-step. You will learn everything you
                                                        need for the Mathematics section of the exam with full support
                                                        and clear explanations.
                                                    </p>
                                                    <p class="mt-3">We focus on making each topic easy to understand,
                                                        even if you
                                                        are starting from scratch. By the end of the course, you will
                                                        feel confident, well-prepared, and ready to score high in the
                                                        exam.</p>
                                                </div>
                                            ...
                                            <ul class="ed-blog__details-list">
                                                <li>
                                                    <img src="assets/images/icons/icon-check-blue.svg"
                                                        alt="icon-check-blue" />
                                                    <p><strong>Basics to Advance: </strong> We start with the basics and
                                                        gradually move towards advanced topics. This ensures you build a
                                                        strong foundation before tackling more difficult concepts.
                                                ...
                                                <li>
                                                    ...
                                                    <p>
                                                        <strong>
                                                            90+ Hours of Recorded Lectures:
                                                        </strong> You’ll have access to over 90 hours of recorded
                                                        lessons that you can watch anytime, allowing you to learn at
                                                        your own pace.
                                                    </p>
                                                </li>
                                                <li>
                                                    <img src="assets/images/icons/icon-check-blue.svg"
                                                        alt="icon-check-blue" />
                                                    <strong>Chapter-wise PDFs:</strong> After each lesson, you’ll get
                                                    PDFs that summarize the chapter, making it easier to review and
                                                    understand the material.
                                                </li>
                                                <li>
                                                    <img src="assets/images/icons/icon-check-blue.svg"
                                                        alt="icon-check-blue" />
                                                    <strong>Conceptual Clarity: </strong> We help you understand the
                                                    "why" and "how" of every topic, so you truly learn instead of just
                                                    memorizing.
                                                </li>
                                                <li>
                                                    <img src="assets/images/icons/icon-check-blue.svg"
                                                        alt="icon-check-blue" />
                                                    <strong>6-Month Program Duration: </strong> The entire program is
                                                    spread out over 6 months, allowing you ample time to learn,
                                                    practice, and revise.
                                                </li>
                                            </ul>
